class WeatherLocation {
  ...
  WeatherLocation fromJson(Map<String, dynamic> json) {
    ...
    if (json['weather'] != null) {
      weather.weather = new List<Weather>();
      json['weather'].forEach((v) {
        weather.weather.add(new Weather.fromJson(v));
      });
    }
    weather.base = json['base'];
    weather.main =
        json['main'] != null ? new Main.fromJson(json['main']) : null;
    weather.visibility = json['visibility'];
    weather.wind =
        json['wind'] != null ? new Wind.fromJson(json['wind']) : null;
    weather.clouds =
        json['clouds'] != null ? new Clouds.fromJson(json['clouds']) : null;
    weather.dt = json['dt'];
    weather.sys = json['sys'] != null ? new Sys.fromJson(json['sys']) : null;
